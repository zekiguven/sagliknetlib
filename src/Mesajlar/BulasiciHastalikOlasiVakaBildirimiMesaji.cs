...
using System.Text;
using SaglikNetLib.WSBulasýcýHastalikOlasiVakaBildirimi;

namespace SaglikNetLib
{
    public class BulasiciHastalikOlasiVakaBildirimiMesaji : BaseMesaj
    {
        ...
        public BulasiciHastalikOlasiVakaBildirimiMesaji()
        {
        }
