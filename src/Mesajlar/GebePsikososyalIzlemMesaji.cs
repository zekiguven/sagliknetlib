...
using System.Text;
using SaglikNetLib.WSGebePsikososyalIzlem;

namespace SaglikNetLib
{
    public class GebePsikososyalIzlemMesaji : BaseMesaj
    {
        ...
        public GebePsikososyalIzlemMSVS GebePsikososyalIzlem;

        public GebePsikososyalIzlemMesaji()
        {
            GebePsikososyalIzlem = new GebePsikososyalIzlemMSVS();
        }
