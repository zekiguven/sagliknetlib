...
using System.Text;
using SaglikNetLib.WSHastaOzlukBilgileri;

namespace SaglikNetLib
{
    public class HastaOzlukBilgileriMesaji : BaseMesaj
    {
        ...
        public HastaOzlukBilgileriMSVS HastaOzlukBilgileri;

        public HastaOzlukBilgileriMesaji()
        {
            HastaOzlukBilgileri = new HastaOzlukBilgileriMSVS();
        }
