...
using System.Text;
using SaglikNetLib.WSBulasiciHastalikKesinVakaBildirimi;

namespace SaglikNetLib
{
    public class BulasiciHastalikKesinVakaBildirimiMesaji : BaseMesaj
    {
        ...
        public BulasiciHastalikKesinVakaBildirimiMesaji()
        {
