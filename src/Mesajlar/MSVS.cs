...
namespace SaglikNetLib
{
    ...
    public class HastaCikisMSVS
    {
        ...
        public HastaCikisMSVS()
        {
            CikisSekli = new CodeDisplayName();
            SevkEdilenPoliklinik = new CodeDisplayName();
            SevkTanisi = new CodeDisplayName();
        }
    }
    ...
    public class TetkikSonucuMSVS
    {
        ...
        public TetkikSonucuMSVS()
        {
            Tetkik = new CodeDisplayName();
        }
    }
    ...
    public class ReceteMSVS
    {
        ...
        public ReceteMSVS()
        {
            ReceteTuru = new CodeDisplayName();
            SosyalGuvenceDurumu= new CodeDisplayName();
            AnaTani= new CodeDisplayName();
