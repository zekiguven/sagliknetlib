...
namespace SaglikNetLib
{
    public class WSSEDraftPolicyAssertion : PolicyAssertion
    {
        ...
        public override IEnumerable<KeyValuePair<string, Type>> GetExtensions()
        {
            return new KeyValuePair<string, Type>[] { 
                new KeyValuePair<string, Type>("WSSEDraftAssertion", this.GetType())
            };
        }
    }
    ...
    class WSSEDraftClientOutputFilter : SoapFilter
    {
        ...
        {
            XmlNodeList nodeList = envelope.Header.GetElementsByTagName("Security", "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wsswssecurity-secext-1.0.xsd");
